...
#######################################################################################################################################################################################
#######################################################################################################################################################################################
script_version   = "NeA1.3" # Network Analysis human 1.0
...
for (loop_var1 in pageRank_dampening_values) {
  for (loop_var2 in pageRank_cutoff_values) {
    ...
    complex_portal         <- fread("/Users/mgesell/Desktop/currentR/git/surfaceome_hybrid_script/NeA_resources/unpacked_tweeked_complex_portal_mg") # "/Users/mgesell/Desktop/currentR/Network_plotting_Cathy/input/unpacked_tweeked_complex_portal_mg/ComplexPortal_human9606_20250218.tsv"  unboxed complexes by mg
    # run the function
