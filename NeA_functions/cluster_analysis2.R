cluster_analysis2 <- function(cluster_method = "walktrap", cluster_min_size = 10, cluster_max_size = 500,
  ...
  load(file = paste0(result_directory, "intermediate/", "p-body_proteins.rds"  ))
  ...
  png(paste0(result_directory, "plots/", "clustered_network_size_filter.png"), width=3600, height = 3600)
  ...
  png(paste0(result_directory, "plots/", "clustered_network_size_filter_new_layout.png"), width=3600,height = 3600)
  ...
  png(paste0(result_directory, "plots/", "lustered_network_significant_new_layout.png"), width=3600,height = 3600)
  ...
  png(paste0(result_directory, "plots/", "lustered_network_significant_final_layout.png"), width=3600,height = 3600)
  ...
  ##### export results
  write.table(cluster_q,         paste0(result_directory, "final/", "cluster_q_values.tsv"), quote = F , sep = "\t", row.names = F)
  save(network_sig,              paste0(result_directory, "final/", "cluster_sig_network.rds"))
  save(layout_clustered_sig_new, paste0(result_directory, "final/", "layout_cluster_sig.rds" ))
}