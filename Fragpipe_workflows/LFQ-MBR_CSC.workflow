...
msfragger.table.var-mods=15.9949,M,true,3; 42.0106,[^,true,1; 79.96633,STY,false,3; -17.0265,nQnC,false,1; -18.0106,nE,false,1; 4.025107,K,false,2; 6.020129,R,false,2; 8.014199,K,false,2; 10.008269,R,false,2; 13.979265,H,false,1; 31.989828,H,false,1; 31.989828,W,false,1; 0.984,N,true,2; 0.0,site_14,false,1; 0.0,site_15,false,1; 0.0,site_16,false,1
...
ptmprophet.cmdline=KEEPOLD STATIC EM\=1 NIONS\=b STY\:79.96633,M\:15.9949,n\:42.0106,N\:0.984 MINPROB\=0.7 FRAGPPMTOL\=10
...
workflow.description=Perform closed search, followed by label free quantification with match-between-runs using IonQuant. If using mzML files, need to choose the right MS data type (Regular MS vs IM-MS). Need to assign runs to experiments.___added N 0.984 as var mod
